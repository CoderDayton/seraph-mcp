...
class OpenAICompatibleProvider(BaseProvider):
    ...
    including local services like LM Studio, Ollama, vLLM, and others.
    """
    ...
    async def complete(self, request: CompletionRequest) -> CompletionResponse:
        ...
        try:
            ...
            # Cost estimation for custom endpoints (usually free or self-hosted)
        ...
        try:
            ...
            for model in models_response.data:
                ...
                model_info = ModelInfo(
                    ...
                    input_cost_per_1k=0.0,  # Usually free for self-hosted
                    output_cost_per_1k=0.0,  # Usually free for self-hosted
                    capabilities=["chat"],
                )
    ...
    async def estimate_cost(
        ...
        Uses Models.dev pricing if available, otherwise assumes free (self-hosted).
        """
        ...
        # Fallback: self-hosted services are typically free
        return 0.0
